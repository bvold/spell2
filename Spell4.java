...
System.out.println("d_count-1 = " + (d_count-1));
...
//System.out.println("curr_word[curr_pos]"+curr_word[curr_pos]);	
	...
	// This isn't needed in JDK1.2, because they now implement it.
  ...
  public static void main (String argv[]) {
	  Spell4 s = new Spell4();
		StringBuffer w = new StringBuffer("eal");
